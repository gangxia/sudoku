 ...
 * state (whether it is editable and valid). 数独的细胞。每个细胞都有价值，重视它的一些注意事项和一些基本的
 * 状态（无论是编辑和有效的）。
 * 
 * @author romario
 * 
...
public class Cell {
	 ...
	 */
	protected void initCollection(CellCollection cellCollection, int rowIndex,
			int colIndex, CellGroup sector, CellGroup row, CellGroup column) {
	 ...
	 * 
	 * @param value
	 *            1-9 or 0 if cell should be empty.
	 */
	 ...
	 * 
	 * @param editable
	 *            True, if cell should allow editing.
	 */
