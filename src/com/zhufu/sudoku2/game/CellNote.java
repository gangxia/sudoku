...
public class CellNote {
	...
	public static CellNote deserialize(String note) {
		// TODO: optimalization: CellNote object don't have to be created for
		// empty note
	 ...
	 * 
	 * @param notedNums
	 *            Array of integers, which should be part of note.
	 ...
	 * string by calling {@link #deserialize(String)}.
	 * 
	 * @param data
	 */
	...
	/**
	 * Toggles noted number: if number is already noted, it will be removed
