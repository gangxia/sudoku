...
import com.zhufu.sudoku2.gui.SudokuBoardView.OnCellSelectedListener;
import com.zhufu.sudoku2.gui.SudokuBoardView.OnCellTappedListener;
...
public class IMControlPanel extends LinearLayout {
	...
	public static final int INPUT_METHOD_SINGLE_NUMBER = 0;
	...
	private void ensureControlPanel(int methodID) {
		...
		if (!im.isInputMethodViewCreated()) {
			...
			Button switchModeButton = (Button) controlPanel
