...
import com.zhufu.sudoku.db.SudokuColumns;
...
import com.zhufu.sudoku.gui.FolderDetailLoader.FolderDetailCallback;
		...
		public boolean setViewValue(View view, Cursor c, int columnIndex) {
			...
			case R.id.state:
				...
				case SudokuGame.GAME_STATE_PLAYING:
					...
					break;
				default:
					stateString = mContext.getString(R.string.unsolved);
					break;
				}
